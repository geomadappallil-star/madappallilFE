export const translations = {
  en: {
    ...
    nav: {
      ...
      faq: "FAQ",
      contact: "Contact",
      bookConsultation: "Book Visit",
      adminPortal: "Leads Vault",
    },
    // Hero Section
    hero: {
      ...
      stat4Number: "100%",
      stat4Label: "Personalized",
    },
    // Interactive Symptom Checker / Specializations
    specialties: {
      ...
      infertility: {
        ...
        keyPoints: [
          "PCOD / PCOS & Ovulation Irregularities",
          "Low AMH & Ovarian Follicle Health",
          "Fallopian Tube Blocks & Fibroids",
          "Low Sperm Count (Oligospermia) & Motility",
          "Support after Failed IUI / IVF Cycles",
          "Endometriosis & Pelvic Pain Relief"
        ],
        advantage: "Balances hormones naturally without synthetic drugs, injections, or painful surgery.",
        cta: "Consult For Infertility"
      },
      mentalHealth: {
        title: "Mental Health & Emotional Well-Being",
        subtitle: "Non-habit forming, gentle homoeopathy for mind and nervous system.",
        keyPoints: [
          "Generalized Anxiety & Panic Attacks",
          "Clinical Depression & Chronic Low Mood",
          "Insomnia & Restless Sleep Disorders",
          "OCD, Overthinking & Stress Exhaustion",
          "Stress-induced Headaches & Acidity",
          "Children's ADHD & Exam Anxiety"
        ],
    ...
    journey: {
      ...
      subtitle: "Simple, transparent, and focused entirely on your recovery.",
      ...
      step4Desc: "Regular monitoring and lifestyle guidance ensuring lasting wellness and healthy conception."
    },
    // Heritage / Doctor
    heritage: {
    ...
    // Interactive Gallery
    gallery: {
      badge: "Clinic Visuals",
      title: "Inside Madappallil Homoeo Dispensary",
      subtitle: "A serene, caring space dedicated to your healing and family wellness.",
      filterAll: "All",
      filterClinic: "Clinic",
      filterInfertility: "Parenthood",
      filterMental: "Mental Peace",
      filterRemedies: "Medicines",
      clickToZoom: "Tap to inspect"
    },
    // Lead Form
    form: {
      badge: "Appointment Request",
      title: "Book Your Consultation",
      subtitle: "Your request is sent directly to the Chief Doctor's email. We will contact you promptly.",
      nameLabel: "Patient Full Name",
      namePlaceholder: "e.g. Anjali Nair",
      phoneLabel: "Phone Number (WhatsApp)",
      phonePlaceholder: "e.g. 98470 12345",
      ...
      successMessage: "Thank you! Your details have been sent directly to the Chief Doctor's email. Our clinic will reach out to you shortly.",
      leadRef: "Reference ID",
      directWhatsappBtn: "Chat on WhatsApp Now",
      privacyNotice: "🔒 100% Confidential. Directly accessed by the Chief Physician.",
      configBtn: "Google Sheet Setup",
      testSubmitNotice: "Test mode active. Connect your Google Apps Script anytime."
    },
    // FAQ
    faq: {
    ...
    contact: {
      ...
      subtitle: "35+ Years of Service in Central Kerala",
      addressLabel: "Address",
      addressValue: "Madappallil Homoeo Dispensary, Main Road, Central Kerala, India",
      timingsLabel: "Consultation Hours",
      timingsValue: "Mon – Sat: 9:30 AM – 1:00 PM & 4:30 PM – 7:30 PM\nSunday: Prior Appointment Only",
      phoneLabel: "Contact Phone",
      phoneValue: "+91 98470 00000",
      emailLabel: "Email",
      emailValue: "madappallilhomoeo@gmail.com",
  ...
  ml: {
    ...
    nav: {
      ...
      faq: "സംശയങ്ങൾ",
      contact: "ബന്ധപ്പെടുക",
      bookConsultation: "ബുക്കിംഗ്",
      adminPortal: "രജിസ്റ്റർ",
    },
    // Hero Section
    hero: {
      ...
      stat4Number: "സുരക്ഷിതം",
      stat4Label: "പ്രകൃതിദത്തം",
    },
    // Interactive Symptom Checker / Specializations
    specialties: {
      ...
      infertility: {
        ...
        keyPoints: [
          "PCOD / PCOS, ക്രമരഹിതമായ ആർത്തവം",
          "കുറഞ്ഞ AMH അളവും അണ്ഡ ഗുണനിലവാരവും",
          "ഫാലോപ്യൻ ട്യൂബ് തടസ്സങ്ങൾ, ഗർഭാശയ മുഴകൾ",
          "പുരുഷന്മാരിലെ ബീജക്കുറവ് (Oligospermia)",
          "പരാജയപ്പെട്ട IUI / IVF ശേഷമുള്ള പരിചരണം",
          "എൻഡോമെട്രിയോസിസ്, കഠിനമായ അടിവയറ്റുവേദന"
        ],
        advantage: "ശരീരത്തിന്റെ സ്വാഭാവിക ഹോർമോൺ തുലനാവസ്ഥ സുരക്ഷിതമായി വീണ്ടെടുക്കുന്നു.",
        cta: "വന്ധ്യതാ കൺസൾട്ടേഷനായി ബുക്ക് ചെയ്യുക"
      },
      mentalHealth: {
        title: "മാനസികാരോഗ്യവും ശാന്തമായ ജീവിതവും",
        subtitle: "മയക്കമോ അടിമപ്പെടലോ ഇല്ലാതെ മനസ്സിന് ശാന്തത നൽകുന്ന ഹോമിയോപ്പതി.",
        keyPoints: [
          "ഉത്കണ്ഠ (Anxiety), പരിഭ്രാന്തി (Panic Attacks)",
          "വിഷാദരോഗം (Depression), മാനസിക തളർച്ച",
          "ഉറക്കമില്ലായ്മ (Insomnia), ദുഃസ്വപ്നങ്ങൾ",
          "അമിത ചിന്തയും സംശയങ്ങളും (OCD)",
          "മാനസിക സമ്മർദ്ദം മൂലമുള്ള തലവേദന, അസിഡിറ്റി",
          "കുട്ടികളിലെ സ്വഭാവ പ്രശ്നങ്ങൾ, പരീക്ഷാപ്പേടി"
        ],
    ...
    // Journey Steps
    journey: {
      badge: "4 ലളിത ഘട്ടങ്ങൾ",
      title: "ഞങ്ങളുടെ ചികിത്സാ രീതി",
      subtitle: "രോഗിയുടെ ശാരീരിക-മാനസിക പ്രത്യേകതകൾ പൂർണ്ണമായി മനസ്സിലാക്കിയുള്ള പരിചരണം.",
      ...
      step4Desc: "പുരോഗതി നിരന്തരം നിരീക്ഷിച്ച് ദീർഘകാല ആരോഗ്യം ഉറപ്പുവരുത്തുന്നു."
    },
    // Heritage / Doctor
    heritage: {
    ...
    gallery: {
      badge: "ചിത്രശാല",
      title: "ക്ലിനിക്ക് കാഴ്ചകൾ",
      subtitle: "ഞങ്ങളുടെ ശാന്തമായ ക്ലിനിക്ക് അന്തരീക്ഷവും മരുന്നുകളും.",
      filterAll: "എല്ലാം",
      filterClinic: "ക്ലിനിക്ക്",
      filterInfertility: "മാതൃത്വം",
      filterMental: "മനഃസമാധാനം",
      filterRemedies: "മരുന്നുകൾ",
      clickToZoom: "ചിത്രത്തിൽ തൊടുക"
    },
    // Lead Form
    form: {
      badge: "കൺസൾട്ടേഷൻ ബുക്കിംഗ്",
      title: "അപ്പോയിന്റ്മെന്റ് ബുക്ക് ചെയ്യാം",
      subtitle: "വിവരങ്ങൾ ഉടൻതന്നെ ഡോക്ടറുടെ ഈമെയിലിലേക്ക് അയക്കപ്പെടുകയും ക്ലിനിക്കിൽ നിന്ന് നിങ്ങളെ തിരിച്ചു വിളിക്കുകയും ചെയ്യും.",
      nameLabel: "രോഗിയുടെ പേര്",
      namePlaceholder: "ഉദാ: അഞ്ജലി നായർ",
      phoneLabel: "ഫോൺ നമ്പർ (WhatsApp)",
      phonePlaceholder: "ഉദാ: 98470 12345",
      emailLabel: "ഇമെയിൽ (ആവശ്യമെങ്കിൽ)",
      emailPlaceholder: "ഉദാ: patient@example.com",
      ...
      timeLabel: "സമയം",
      timeMorning: "രാവിലെ (9:30 AM - 1:00 PM)",
      ...
      successMessage: "നന്ദി! വിവരങ്ങൾ ഡോക്ടറുടെ ഈമെയിലിലേക്ക് അയച്ചു. ക്ലിനിക്കിൽ നിന്നും ഉടൻ നിങ്ങളെ വിളിക്കുന്നതാണ്.",
      leadRef: "റഫറൻസ് നമ്പർ",
      directWhatsappBtn: "WhatsApp-ൽ ഇപ്പോൾ സംസാരിക്കാം",
      privacyNotice: "🔒 വിവരങ്ങൾ പൂർണ്ണമായും രഹസ്യമായി സൂക്ഷിക്കുന്നതാണ്.",
      configBtn: "ഗൂഗിൾ ഷീറ്റ് സജ്ജീകരണം",
      testSubmitNotice: "ടെസ്റ്റ് സമർപ്പണ രീതി സജീവം."
    },
    // FAQ
    faq: {
      badge: "സംശയങ്ങൾ",
    ...
    contact: {
      ...
      subtitle: "35-ലധികം വർഷങ്ങളായി ജനസേവനത്തിൽ",
      addressLabel: "വിലാസം",
      addressValue: "മാടപ്പള്ളിൽ ഹോമിയോ ഡിസ്പെൻസറി, മെയിൻ റോഡ്, സെൻട്രൽ കേരളം, ഇന്ത്യ",
      timingsLabel: "പരിശോധനാ സമയം",
      timingsValue: "തിങ്കൾ – ശനി: രാവിലെ 9:30 – ഉച്ചയ്ക്ക് 1:00 & വൈകിട്ട് 4:30 – 7:30\nഞായർ: മുൻകൂട്ടിയുള്ള ബുക്കിംഗ് പ്രകാരം മാത്രം",
